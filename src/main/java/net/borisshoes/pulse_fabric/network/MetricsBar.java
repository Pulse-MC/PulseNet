 ...
 * Players toggle it on/off with /pulse bar.
 */
public class MetricsBar {
   ...
   static{
      bossBar = new ServerBossEvent(
            Component.translatable("text.pulse-fabric.metrics.bar_title"),
   ...
   public static void updateBar(){
      ...
      try{
         ...
         Component title = Component.empty()
               .append(Component.translatable("text.pulse-fabric.metrics.label").withStyle(ChatFormatting.BOLD, ChatFormatting.LIGHT_PURPLE))
               .append(Component.translatable("text.pulse-fabric.metrics.separator").withStyle(ChatFormatting.DARK_GRAY))
               .append(Component.translatable("text.pulse-fabric.metrics.efficiency", Component.literal((int) (efficiency * 100) + "%").withStyle(effColor)).withStyle(ChatFormatting.WHITE))
               .append(Component.translatable("text.pulse-fabric.metrics.separator").withStyle(ChatFormatting.DARK_GRAY))
               .append(Component.translatable("text.pulse-fabric.metrics.vanilla_pps", Component.literal((int) Metrics.ppsLogical + " p/s").withStyle(ChatFormatting.AQUA)).withStyle(ChatFormatting.WHITE))
               .append(Component.translatable("text.pulse-fabric.metrics.separator").withStyle(ChatFormatting.DARK_GRAY))
               .append(Component.translatable("text.pulse-fabric.metrics.actual_pps", Component.literal((int) Metrics.ppsPhysical + " p/s").withStyle(ChatFormatting.AQUA)).withStyle(ChatFormatting.WHITE))
         ...
         PulseFabric.LOGGER.debug("MetricsBar update error: {}", e.getMessage());
      }
   }
