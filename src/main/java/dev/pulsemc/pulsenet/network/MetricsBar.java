...
public class MetricsBar {
   ...
   static{
      bossBar = new ServerBossEvent(
            ...
            Component.translatable("text.pulsenet.metrics.bar_title"),
   ...
   public static void updateBar(){
      ...
      try{
         ...
         Component title = Component.empty()
               .append(Component.translatable("text.pulsenet.metrics.label").withStyle(ChatFormatting.BOLD, ChatFormatting.LIGHT_PURPLE))
               .append(Component.translatable("text.pulsenet.metrics.separator").withStyle(ChatFormatting.DARK_GRAY))
               .append(Component.translatable("text.pulsenet.metrics.efficiency", Component.literal((int) (efficiency * 100) + "%").withStyle(effColor)).withStyle(ChatFormatting.WHITE))
               .append(Component.translatable("text.pulsenet.metrics.separator").withStyle(ChatFormatting.DARK_GRAY))
               .append(Component.translatable("text.pulsenet.metrics.vanilla_pps", Component.literal((int) Metrics.ppsLogical + " p/s").withStyle(ChatFormatting.AQUA)).withStyle(ChatFormatting.WHITE))
               .append(Component.translatable("text.pulsenet.metrics.separator").withStyle(ChatFormatting.DARK_GRAY))
               .append(Component.translatable("text.pulsenet.metrics.actual_pps", Component.literal((int) Metrics.ppsPhysical + " p/s").withStyle(ChatFormatting.AQUA)).withStyle(ChatFormatting.WHITE))
         ...
         PulseNet.LOGGER.debug("MetricsBar update error: {}", e.getMessage());
      }
   }
